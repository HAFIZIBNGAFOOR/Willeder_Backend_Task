...
import { VALIDATION_ACCOUNT_TEL, VALIDATION_EMAIL_EXIST, VALIDATION_EMAIL_NOT_EXIST, VALIDATION_PASSWORD, VALIDATION_PASSWORD_CHECK, VALIDATION_STRING } from '../../../constants/validation';
